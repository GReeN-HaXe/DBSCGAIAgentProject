...
def main() -> None:
    parser = argparse.ArgumentParser(description="Normalize raw AI-vs-AI trace into review/training formats.")
    parser.add_argument("--input", type=Path, required=True, help="Raw AI trace JSON path.")
