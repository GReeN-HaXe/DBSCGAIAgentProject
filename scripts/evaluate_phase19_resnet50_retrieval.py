...
from src.agent import evaluate_phase19_resnet50_retrieval
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate Phase 19 ResNet50 retrieval.")
    ...
    payload = evaluate_phase19_resnet50_retrieval(
