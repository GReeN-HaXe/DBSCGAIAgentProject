...
from src.agent import evaluate_phase20_resnet18_hybrid_retrieval
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate Phase 20 ResNet18 hybrid retrieval.")
    ...
    payload = evaluate_phase20_resnet18_hybrid_retrieval(
