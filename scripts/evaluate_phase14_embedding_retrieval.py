...
from src.agent import evaluate_phase14_embedding_retrieval
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate embedding-style retrieval from a Phase 14 model and feature cache.")
    ...
    parser.add_argument("--output", type=Path, default=Path("artifacts/phase14_embedding_retrieval.json"))
    args = parser.parse_args()

    payload = evaluate_phase14_embedding_retrieval(
