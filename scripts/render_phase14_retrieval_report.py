...
def main() -> None:
    parser = argparse.ArgumentParser(description="Render a Phase 14 retrieval markdown report.")
    parser.add_argument("--retrieval", type=Path, required=True)
    parser.add_argument("--output", type=Path, default=Path("artifacts/phase14_retrieval_report.md"))
