...
from src.agent import evaluate_phase16_cnn_retrieval
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate Phase 16 CNN retrieval.")
    ...
    parser.add_argument("--output", type=Path, default=Path("artifacts/phase16_cnn_retrieval.json"))
    args = parser.parse_args()

    payload = evaluate_phase16_cnn_retrieval(
