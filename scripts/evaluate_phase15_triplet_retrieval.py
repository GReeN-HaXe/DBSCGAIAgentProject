...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate Phase 15 triplet retrieval.")
    ...
    parser.add_argument("--output", type=Path, default=Path("artifacts/phase15_retrieval.json"))
    args = parser.parse_args()

    payload = evaluate_phase15_triplet_retrieval(
