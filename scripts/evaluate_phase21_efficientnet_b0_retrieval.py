...
from src.agent import evaluate_phase21_efficientnet_b0_retrieval
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate Phase 21 EfficientNet-B0 retrieval.")
    ...
    payload = evaluate_phase21_efficientnet_b0_retrieval(
