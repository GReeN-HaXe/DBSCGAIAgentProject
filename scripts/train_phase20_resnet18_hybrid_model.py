...
from src.agent import train_phase20_resnet18_hybrid_model
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train a Phase 20 ResNet18 hybrid model.")
    ...
    payload = train_phase20_resnet18_hybrid_model(
