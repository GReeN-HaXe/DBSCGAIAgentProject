...
from src.agent import evaluate_phase13_visual_model
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate the Phase 13 visual model.")
    ...
    parser.add_argument("--output", type=Path, default=Path("artifacts/phase13_visual_eval.json"), help="Evaluation output path.")
    args = parser.parse_args()

    payload = evaluate_phase13_visual_model(
