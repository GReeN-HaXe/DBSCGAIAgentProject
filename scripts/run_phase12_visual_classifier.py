...
from src.agent import run_phase12_visual_model
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the Phase 12 visual classifier on proposal boxes.")
    ...
    parser.add_argument("--output", type=Path, default=Path("artifacts/phase12_visual_predictions.json"), help="Output detection manifest path.")
    args = parser.parse_args()

    payload = run_phase12_visual_model(
