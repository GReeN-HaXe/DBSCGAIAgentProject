...
from src.agent import evaluate_phase11_recognizer_model
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate the trained Phase 11 recognizer against labeled detections.")
    ...
    parser.add_argument("--output", type=Path, default=Path("artifacts/phase11_recognizer_eval.json"), help="Evaluation output path.")
    args = parser.parse_args()

    payload = evaluate_phase11_recognizer_model(
